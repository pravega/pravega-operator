...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SegmentStoreSpec) DeepCopyInto(out *SegmentStoreSpec) {
	*out = *in
	if in.Options != nil {
		in, out := &in.Options, &out.Options
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SegmentStoreSpec.
func (in *SegmentStoreSpec) DeepCopy() *SegmentStoreSpec {
	if in == nil {
		return nil
	}
	out := new(SegmentStoreSpec)
