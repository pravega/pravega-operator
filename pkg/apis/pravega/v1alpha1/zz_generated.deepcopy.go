...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PravegaJVMOptions) DeepCopyInto(out *PravegaJVMOptions) {
	*out = *in
	...
	if in.Segmentstore != nil {
		in, out := &in.Segmentstore, &out.Segmentstore
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PravegaJVMOptions.
func (in *PravegaJVMOptions) DeepCopy() *PravegaJVMOptions {
	if in == nil {
		return nil
	}
	out := new(PravegaJVMOptions)
	in.DeepCopyInto(out)
	return out
}
