...
### LongTermStorage
To setup LongTermStorage refer to [this](https://github.com/pravega/pravega-operator/wiki/LongTermStorage#use-nfs-as-longtermstorage). The `PersistentVolumeClaim` to consume the volume so created should be provisioned to consume 10Gi.
