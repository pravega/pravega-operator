...
import (
	...
	apis2 "github.com/pravega/pravega-operator/pkg/apis"
...
func TestAPIs(t *testing.T) {
	...
	Expect(apis2.AddToScheme(scheme.Scheme)).Should(Succeed())
	Expect(v1beta1.SchemeBuilder.AddToScheme(scheme.Scheme)).Should(Succeed())
	...
	recFn, requests = SetupTestReconcile(pravegacluster.NewReconciler(mgr))
	err = pravegacluster.Add(mgr, recFn)
	Expect(err).NotTo(HaveOccurred())
